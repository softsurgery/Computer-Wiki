...
The CLI installation guide details [supported database and versions](https://docs.strapi.io/dev-docs/installation/cli#preparing-the-installation).

✏️ Note

Strapi `v4.6.2` introduced a new format for the database configuration file that allows all of the database configuration properties to be set using environment variables. Only new projects created after the `v4.6.2` release will include the new configuration, however, earlier projects can utilize the new configuration by manually modifying the `./config/database.js` or `./config/database.ts` and updating the `.env` file. See [environment variables in database configurations](https://docs.strapi.io/dev-docs/configurations/database#environment-variables-in-database-configurations)

## Configuration structure

The `./config/database.js` (or `./config/database.ts` for TypeScript) accepts 2 main configuration objects:

- `[connection](<https://docs.strapi.io/dev-docs/configurations/database#connection-configuration-object>)` for database configuration options passed to [Knex.js](https://github.com/knex/knex)
- `[settings](<https://docs.strapi.io/dev-docs/configurations/database#settings-configuration-object>)` for Strapi-specific database settings

### `connection` configuration object

|Parameter|Description|Type|Default|
|---|---|---|---|
|client|Database client to create the connection. sqlite or postgres or mysql (or mysql2, see [https://docs.strapi.io/dev-docs/configurations/database#alternative-database-driver-packages](https://docs.strapi.io/dev-docs/configurations/database#alternative-database-driver-packages)|String|-|
|connection|Database [https://docs.strapi.io/dev-docs/configurations/database#connection-parameters](https://docs.strapi.io/dev-docs/configurations/database#connection-parameters)|Object|-|
|debug|Show database exchanges and errors.|Boolean|false|
|useNullAsDefaultOptional, only for SQLite|Use NULL as a default value|Boolean|true|
|poolOptional|[https://docs.strapi.io/dev-docs/configurations/database#database-pooling-options](https://docs.strapi.io/dev-docs/configurations/database#database-pooling-options)|Object|-|
|acquireConnectionTimeoutOptional|How long knex will wait before throwing a timeout error when acquiring a connection (in milliseconds)|Integer|60000|
...
|---|---|---|
|connectionString|[https://docs.strapi.io/dev-docs/configurations/database#database-connections-using-connectionstring](https://docs.strapi.io/dev-docs/configurations/database#database-connections-using-connectionstring). When set, it overrides the other connection.connection properties. To disable use an empty string: ''. Available in Strapi v4.6.2+|String|
...
|timezone|Set the default behavior for local time. Default value: utc [https://www.php.net/manual/en/timezones.php](https://www.php.net/manual/en/timezones.php)|String|
...
|afterCreate|Callback function to execute custom logic when the pool acquires a new connection.See the [https://knexjs.org/#Installation-pooling](https://knexjs.org/#Installation-pooling) for more information|Function|-|
...
1. Update your application to `v4.6.2` or a later version. See the [Updates and Migrations](https://docs.strapi.io/dev-docs/migration-guides) section for any breaking changes that require specific fixes.
...
- [SQLite installation guide](https://docs.strapi.io/dev-docs/configurations/sqlite),
