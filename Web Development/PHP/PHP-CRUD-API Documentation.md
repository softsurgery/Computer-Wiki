...
[](https://github.com/mevdschee/php-crud-api#requirements)
...
[](https://github.com/mevdschee/php-crud-api#installation)

Download the "`api.php`" file from the latest release:

[https://github.com/mevdschee/php-crud-api/releases/latest](https://github.com/mevdschee/php-crud-api/releases/latest) or direct from:  
[https://raw.githubusercontent.com/mevdschee/php-crud-api/main/api.php](https://raw.githubusercontent.com/mevdschee/php-crud-api/main/api.php)
...
[](https://github.com/mevdschee/php-crud-api#limitations)
...
[](https://github.com/mevdschee/php-crud-api#features)
...
[](https://github.com/mevdschee/php-crud-api#related-projects-and-ports)
...
[](https://github.com/mevdschee/php-crud-api#development)
...
[](https://github.com/mevdschee/php-crud-api#updating-dependencies)
...
[](https://github.com/mevdschee/php-crud-api#treeql-a-pragmatic-graphql)
...
[](https://github.com/mevdschee/php-crud-api#crud--list)
...
[](https://github.com/mevdschee/php-crud-api#create)
...
[](https://github.com/mevdschee/php-crud-api#read)
...
[](https://github.com/mevdschee/php-crud-api#update)
...
[](https://github.com/mevdschee/php-crud-api#delete)
...
[](https://github.com/mevdschee/php-crud-api#list)
...
[](https://github.com/mevdschee/php-crud-api#filters)
...
[](https://github.com/mevdschee/php-crud-api#column-selection)
...
[](https://github.com/mevdschee/php-crud-api#ordering)
...
[](https://github.com/mevdschee/php-crud-api#limit-size)
...
[](https://github.com/mevdschee/php-crud-api#pagination)
...
[](https://github.com/mevdschee/php-crud-api#joins)
...
[](https://github.com/mevdschee/php-crud-api#batch-operations)
...
[](https://github.com/mevdschee/php-crud-api#spatial-support)
...
[](https://github.com/mevdschee/php-crud-api#geojson)
...
[](https://github.com/mevdschee/php-crud-api#mapping-names-for-legacy-systems)
...
[](https://github.com/mevdschee/php-crud-api#middleware)
...
[](https://github.com/mevdschee/php-crud-api#authentication)
...
[](https://github.com/mevdschee/php-crud-api#api-key-authentication)
...
[](https://github.com/mevdschee/php-crud-api#api-key-database-authentication)
...
[](https://github.com/mevdschee/php-crud-api#database-authentication)
...
For login operations, it is possible to use a view as the usersTable. Such view can return a filtered result from the users table, e.g., _where active = true_ or it may also return a result multiple tables thru a table join. At a minimum, the view should include the _**username**_ and _**password**_ and a field named _**id**_.

However, views with joined tables are not insertable ([see issue 907](https://github.com/mevdschee/php-crud-api/issues/907) ). As a workaround, use the property _**loginTable**_ to set a different reference table for login. The **usersTable** will still be set to the normal, insertable users table.

#### Wordpress authentication

[](https://github.com/mevdschee/php-crud-api#wordpress-authentication)
...
[](https://github.com/mevdschee/php-crud-api#basic-authentication)
...
[](https://github.com/mevdschee/php-crud-api#configure-and-test-jwt-authentication-with-auth0)

First you need to create an account on [Auth0](https://auth0.com/auth/login). Once logged in, you have to create an application (its type does not matter). Collect the `Domain` and `Client ID` and keep them for a later use. Then, create an API: give it a name and fill the `identifier` field with your API endpoint's URL.
...
To test your integration, you can copy the [auth0/vanilla.html](https://github.com/mevdschee/php-crud-api/blob/main/examples/clients/auth0/vanilla.html) file. Be sure to fill these three variables:
...
[](https://github.com/mevdschee/php-crud-api#configure-and-test-jwt-authentication-with-firebase)

First you need to create a Firebase project on the [Firebase console](https://console.firebase.google.com/). Add a web application to this project and grab the code snippet for later use.

Then you have to configure the `jwtAuth.secrets` configuration in your `api.php` file. This can be done as follows:

a. Log a user in to your Firebase-based app, get an authentication token for that user b. Go to [https://jwt.io/](https://jwt.io/) and paste the token in the decoding field c. Read the decoded header information from the token, it will give you the correct `kid` d. Grab the public key via this [URL](https://www.googleapis.com/robot/v1/metadata/x509/securetoken@system.gserviceaccount.com), which corresponds to your `kid` from previous step e. Now, just fill `jwtAuth.secrets` with your public key in the `api.php`
...
To test your integration, you can copy the [firebase/vanilla.html](https://github.com/mevdschee/php-crud-api/blob/main/examples/clients/firebase/vanilla.html) file and the [firebase/vanilla-success.html](https://github.com/mevdschee/php-crud-api/blob/main/examples/clients/firebase/vanilla-success.html) file, used as a "success" page and to display the API result.
...
[](https://github.com/mevdschee/php-crud-api#authorizing-operations)
...
[](https://github.com/mevdschee/php-crud-api#authorizing-tables-columns-and-records)
...
[](https://github.com/mevdschee/php-crud-api#sql-grant-authorization)
...
[](https://github.com/mevdschee/php-crud-api#sanitizing-input)
...
[](https://github.com/mevdschee/php-crud-api#type-sanitation)
...
[](https://github.com/mevdschee/php-crud-api#validating-input)
...
[](https://github.com/mevdschee/php-crud-api#type-validations)
...
[](https://github.com/mevdschee/php-crud-api#multi-tenancy-support)
...
[](https://github.com/mevdschee/php-crud-api#multi-tenancy-middleware)
...
[](https://github.com/mevdschee/php-crud-api#reconnect-middleware)
...
[](https://github.com/mevdschee/php-crud-api#prevent-database-scraping)
...
[](https://github.com/mevdschee/php-crud-api#search-all-text-fields)
...
[](https://github.com/mevdschee/php-crud-api#customization-handlers)
...
[](https://github.com/mevdschee/php-crud-api#json-encoding-options)
...
[](https://github.com/mevdschee/php-crud-api#json-middleware)
...
[](https://github.com/mevdschee/php-crud-api#xml-middleware)
...
[](https://github.com/mevdschee/php-crud-api#file-uploads)
...
[](https://github.com/mevdschee/php-crud-api#openapi-specification)
...
[](https://github.com/mevdschee/php-crud-api#cache)
...
[](https://github.com/mevdschee/php-crud-api#types)
...
[](https://github.com/mevdschee/php-crud-api#data-types-in-javascript)
...
[](https://github.com/mevdschee/php-crud-api#64-bit-integers)
...
[](https://github.com/mevdschee/php-crud-api#inf-and-nan-floats)
...
[](https://github.com/mevdschee/php-crud-api#errors)
...
[](https://github.com/mevdschee/php-crud-api#status)
...
[](https://github.com/mevdschee/php-crud-api#tests)
...
[](https://github.com/mevdschee/php-crud-api#running)
...
[](https://github.com/mevdschee/php-crud-api#pretty-url)

You may "rewrite" the URL to remove the "api.php" from the URL.

### Apache config example

[](https://github.com/mevdschee/php-crud-api#apache-config-example)
...
[](https://github.com/mevdschee/php-crud-api#nginx-config-example)
...
[](https://github.com/mevdschee/php-crud-api#docker-tests)
...
[](https://github.com/mevdschee/php-crud-api#docker-image)
...
[](https://github.com/mevdschee/php-crud-api#docker-compose)
