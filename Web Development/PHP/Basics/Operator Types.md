[PHP - Operator Types](https://www.tutorialspoint.com/php/php_operator_types.htm)

**What is Operator?** Simple answer can be given using expression _4 + 5 is equal to 9_. Here 4 and 5 are called operands and + is called operator. PHP language supports following type of operators.
