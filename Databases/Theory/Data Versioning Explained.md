[lakefs.io](https://lakefs.io/blog/data-versioning/)
# Introduction
...
![lakefs versioning data model branches commits](https://cdn-kfpfp.nitrocdn.com/LPJTcQItTfFXIvmLmluGDpHNkMGCVcPt/assets/images/optimized/rev-7a74f54/lakefs.io/wp-content/uploads/2021/11/data-versioning-in-lakeFS-data-model-1024x574.png)
...
![metaranges and ranges data model lakefs](https://cdn-kfpfp.nitrocdn.com/LPJTcQItTfFXIvmLmluGDpHNkMGCVcPt/assets/images/optimized/rev-7a74f54/lakefs.io/wp-content/uploads/2021/11/lakefs-ranges-metaranges-data-model-objects.png)

Pointers between ranges and objects prevent data duplication.

What’s the point of all this? When it comes to time travel, we now have a super-easy way to navigate amongst the different data versions (_by using the unique generated lakeFS commit_id in each commit_).
...
![detecting objects with Machine Learning in photographs](https://cdn-kfpfp.nitrocdn.com/LPJTcQItTfFXIvmLmluGDpHNkMGCVcPt/assets/images/optimized/rev-7a74f54/lakefs.io/wp-content/uploads/2021/11/data-versioning-object-detection.png)
...
Learn more about [Data Version Control Best Practices](https://lakefs.io/data-version-control/dvc-best-practices/)
