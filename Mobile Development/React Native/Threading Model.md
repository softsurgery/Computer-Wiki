This document refers to the [[React Native - New Architecture]], that is in active roll-out.

#### The React Native renderer distributes the work of the [render pipeline](https://reactnative.dev/architecture/render-pipeline) across multiple threads.
